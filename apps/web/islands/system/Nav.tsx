...
import { Badge, BadgeColor } from "@web/islands"
    ...
    subItems: [
      {
        ...
        // counter: computed(() => state.region.list.nonDeleted.value.length),
      },
    ],
  },
]
      ...
      <nav class="flex flex-1 flex-col gap-4">
        ...
        <div class="relative mt-auto">
          ...
          {isProfileDropdownOpen.value && (
            <div
              class="absolute bottom-full left-0 z-1000 mb-2 w-full origin-bottom-right rounded-primary bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none"
              role="menu"
